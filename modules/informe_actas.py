...
def crear_informe_actas(panel):
    ...
    ttk.Button(fp,text="Cambiar carpeta",bootstyle="secondary",command=lambda:cambiar_proyecto(ruta,est)).pack(anchor="e")
    ...
    ttk.Button(fm,text="▶ Generar Informe",bootstyle="success",width=24,command=lambda:ejecutar_actas(modo.get())).pack(pady=10)
